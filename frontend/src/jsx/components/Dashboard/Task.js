                            ...
                            <div className="card-body p-0 pb-3">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">
                                        <span className="text-black mb-0 title">Deadline Date</span> :
                                        <span className=" ms-2">{contact.Date_Join}</span>
                                    </li>
                                    <li className="list-group-item">
                                        <span className="text-black mb-0 title">Client Name</span> :
                                         <span className=" ms-2">{contact.Cust_Name}</span> 
                                    </li>
                                    <li className="list-group-item">
                                        <span className="text-black mb-0 title">Location</span> :
                                        <span className=" desc-text ms-2">{contact.Location}</span>
                                    </li>
                                </ul>
                            </div>
